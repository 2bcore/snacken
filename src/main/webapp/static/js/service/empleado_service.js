...
App.factory('EmpleadoService', ['$http', '$q', function($http, $q){
	...
	return {
			...
			fetchAllEmpleados: function() {
					return $http.get('${protocolo}://${rest-host-name}:${rest-host-port}/${app-name}/empleado/')
							.then(
									function(response){
		    ...
		    createEmpleado: function(empleado){
					return $http.post('${protocolo}://${rest-host-name}:${rest-host-port}/${app-name}/empleado/', empleado)
							.then(
									function(response){
										return response.data;
									}, 
		    ...
		    updateEmpleado: function(empleado, id){
					return $http.put('${protocolo}://${rest-host-name}:${rest-host-port}/${app-name}/empleado/'+id, empleado)
							.then(
									function(response){
										return response.data;
									}, 
			...
			deleteEmpleado: function(id){
					return $http.delete('${protocolo}://${rest-host-name}:${rest-host-port}/${app-name}/empleado/'+id)
							.then(
									function(response){
										return response.data;
									}, 
