...
App.factory('EmpleadoService', ['$http', '$q', function($http, $q){
	...
	return {
			...
			fetchAllEmpleados: function() {
					return $http.get('http://192.168.248.130:8080/spring-rest-demo/empleado/')
							.then(
									function(response){
		    ...
		    createEmpleado: function(empleado){
					return $http.post('http://192.168.248.130:8080/spring-rest-demo/empleado/', empleado)
							.then(
									function(response){
										return response.data;
									}, 
		    ...
		    updateEmpleado: function(empleado, id){
					return $http.put('http://192.168.248.130:8080/spring-rest-demo/empleado/'+id, empleado)
							.then(
									function(response){
										return response.data;
									}, 
			...
			deleteEmpleado: function(id){
					return $http.delete('http://192.168.248.130:8080/spring-rest-demo/empleado/'+id)
							.then(
									function(response){
										return response.data;
									}, 
